            ...
            <div className={classes.counter}>
              <Card className={cx(classes.card, classes.primary)}>
                ...
                <div className={classes.count}>
                  ...
                  <Typography variant="h5">{t('about_d')}</Typography>
                </div>
              </Card>
              <Card className={cx(classes.card, classes.secondary)}>
                ...
                />
                <div className={classes.count}>
                  <Typography variant="h5">{t('about_f')}</Typography>
                  <Typography variant="h2">2025</Typography>
                </div>
              </Card>
              <Card className={cx(classes.card, classes.accent)}>
                ...
                <div className={classes.count}>
                  ...
                  <Typography variant="h5">{t('about_p')}</Typography>
                </div>
              </Card>
            </div>
          </Grid>
